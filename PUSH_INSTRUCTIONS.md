...
git init
git add .
git commit -m "Initial review tooling release candidate"
gh repo create maxliebscher/scroll-review-tooling --public --source . --remote origin --push
```
...
Do not include `demo/out/`, `__pycache__/`, `.pytest_cache/`, private collaboration exports, strategic audit notes, candidate hypotheses, CT data, model checkpoints, model outputs, secrets, or local absolute paths.
